...
web](http://godoc.org/github.com/olehz/hyperleveldb-go).
...
1.4](https://github.com/olehz/hyperleveldb-go_leveldb_1.4). Prefer putting in the
...
standard places for your OS, you'll be able to simply run:
    ...
    go get github.com/olehz/hyperleveldb-go
...
levigo remotely, you'll run:
    ...
    CGO_CFLAGS="-I/path/to/leveldb/include" CGO_LDFLAGS="-L/path/to/leveldb/lib" go get github.com/olehz/hyperleveldb-go
...
you'll run something like:
    ...
    CGO_LDFLAGS="-L/path/to/leveldb/lib -L/path/to/snappy/lib -lsnappy" go get github.com/olehz/hyperleveldb-go
...
<https://github.com/olehz/hyperleveldb-go/blob/master/examples>.
